...
A live demo, using the sepsis event log [1] and a query with multiple constraints, can be found here: [https://editor.notation3.org/pqn/s/CtJzfENk](https://editor.notation3.org/pqn/s/CtJzfENk).
