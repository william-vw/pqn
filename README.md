...
A live demo, using the sepsis event log [1] and a query with multiple constraints, can be found here: [https://n3-editor.herokuapp.com/n3/pqn/s/z6duWaSv](https://n3-editor.herokuapp.com/n3/pqn/s/z6duWaSv).
